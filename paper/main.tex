...
\label{tab:sts-score}
\begin{center}
\begin{tabularx}{0.45\textwidth}{llr}
\toprule
Score & Explanation\\
\midrule
...
\midrule
4 & \multicolumn{1}{m{6cm}}{\textit{The two sentences are mostly equivalent, but some unimportant details differ}} \\
  & \multicolumn{1}{m{6cm}}{In May 2010, the troops attempted to invade
Kabul.} \\
& \multicolumn{1}{m{6cm}}{The US army invaded Kabul on May 7th last
year, 2010.} \\
\midrule
3 & \multicolumn{1}{m{6cm}}{\textit{The two sentences are roughly equivalent, but some important information differs/missing.}} \\
  & \multicolumn{1}{m{6cm}}{John said he is considered a witness but not a
suspect.}\\
& ``He is not a suspect anymore.'' John said.\\
\midrule
2 & \multicolumn{1}{m{6cm}}{\textit{The two sentences are not equivalent, but share some details.}} \\
&They flew out of the nest in groups. \\
&They flew into the nest together. \\
\midrule
1 & \multicolumn{1}{m{6cm}}{\textit{The two sentences are not equivalent, but are on the same topic.}}\\
& The woman is playing the violin.\\
& The young lady enjoys listening to the guitar.\\
\midrule
0 & \textit{The two sentences are completely dissimilar.}\\
  & \multicolumn{1}{m{6cm}}{John went horse back riding at dawn with a whole group of friends.}\\
  & \multicolumn{1}{m{6cm}}{Sunrise at dawn is a magnificent view to take in if you wake up early enough for it.}\\
\bottomrule
\end{tabularx}
\end{center}
\end{table*}
